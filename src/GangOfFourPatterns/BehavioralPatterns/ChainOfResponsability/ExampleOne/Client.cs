using src.GangOfFourPatterns.BehavioralPatterns.ChainOfResponsability.ExampleOne.Handlers;
using System;
using System.Collections.Generic;

namespace src.GangOfFourPatterns.BehavioralPatterns.ChainOfResponsability.ExampleOne
{
    public class Client
    {
